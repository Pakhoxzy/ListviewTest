...
public class LoginActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void bindViews() {
        edit_user = (EditText) findViewById(R.id.text1);
        edit_pawd = (EditText) findViewById(R.id.text2);
    ...
    public void onClick(View v) {
        ...
        if(user.equals("12345678")&&pawd.equals("12345678")){
            editor = pref.edit();
            ...
            Toast.makeText(LoginActivity.this,"输入正确，即将跳转页面",Toast.LENGTH_SHORT).show();
            finish();
        }else{
